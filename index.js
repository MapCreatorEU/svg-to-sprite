...
[1, 2, 4].forEach(function(pxRatio) {
    ...
    spritezero.generateLayout({ imgs: svgs, pixelRatio: pxRatio, format: true, removeOversizedIcons: true }, function(err, dataLayout) {
        if (err) return;
    ...
    spritezero.generateLayout({ imgs: svgs, pixelRatio: pxRatio, format: false, removeOversizedIcons: true }, function(err, imageLayout) {
